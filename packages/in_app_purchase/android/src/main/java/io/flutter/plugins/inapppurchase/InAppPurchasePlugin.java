    ...
    billingClient.querySkuDetailsAsync(
        ...
        new SkuDetailsResponseListener() {
          public void onSkuDetailsResponse(
                  BillingResult billingResult, @Nullable List<SkuDetails> skuDetailsList) {
            updateCachedSkus(skuDetailsList);
            final Map<String, Object> skuDetailsResponse = new HashMap<>();
            skuDetailsResponse.put("responseCode", billingResult.getResponseCode());
    ...
    ConsumeResponseListener listener =
        new ConsumeResponseListener() {
          ...
          public void onConsumeResponse(
              BillingResult billingResult, String outToken) {
            result.success(billingResult.getResponseCode());
          }
        };
    ...
    billingClient.queryPurchaseHistoryAsync(
        ...
        new PurchaseHistoryResponseListener() {
          ...
          public void onPurchaseHistoryResponse(BillingResult billingResult, List<PurchaseHistoryRecord> purchaseHistoryRecordList) {
            ...
            serialized.put("purchasesList", fromPurchaseHistoryRecordList(purchaseHistoryRecordList));
